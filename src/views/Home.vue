	...
	<section id="home" class="home">
		<div class="left">
			<h1 class="left-title">
				...
				<span class="left-title__second">Я </span>
				<span class="left-title__third"><i style="font-style: normal">Максим</i></span>
				<span class="left-title__fours">,</span>
				<div class="left-title__fifth"><strong>веб&#8209;разработчик</strong></div>
			<div class="left-title__subtitle">вёрстка • интеграция • разработка</div>
			</h1>
